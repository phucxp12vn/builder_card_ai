  ...
  return (
    <Card mb={{ base: '0px', '2xl': '20px' }} p={'20px'}>
      ...
      <Text color={textColorSecondary} fontSize="md" me="26px">
        Work great for listicle e.g. 7 tip for house painting or How to use AI for copy writing?
      </Text>
      <Divider color={textColorSecondary} my="8px" />
      <Box>
        <form onSubmit={formik.handleSubmit}>
          <FormControl isInvalid={Boolean(formik.errors.words) && formik.touched.words}>
